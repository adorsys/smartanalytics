...
public class RuleServiceTest {
    ...
    public void test() {
        ...
        booking.setPurpose("Sepa-basislastschrift Eref+ 2622256 Mref+ Okf100000032243 Cred+ De37zzz00000000661 Svwz+ " +
            "45846/Fad 45846-2 Abfall 2017 Am Wasen 8/37,05/15.11.17");
        ...
        assertThat(wrappedBooking.getOtherAccount()).containsSequence("Testreceiver");
        assertThat(wrappedBooking.getMainCategory()).containsSequence("Testgroup");
    }
    ...
    public void overwriteGroup() {
        ...
        assertThat(wrappedBooking.getOtherAccount()).containsSequence("Testreceiver");
        assertThat(wrappedBooking.getMainCategory()).containsSequence("OverwritenGroup");
    }
    ...
    private Rule createRule(final String expression, final String receiver, final String mainCategory,
